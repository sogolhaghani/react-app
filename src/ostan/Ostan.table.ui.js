...
import { handleRequestSort, setPage, loadEntity, createEntity, deleteEntities, handleReadValidation } from './ostan.actions'
...
function EnhancedTableHead(props) {
  ...
  const headCells = useSelector(state => state.ostan.headCells) || []
...
export default function EnhancedTable() {
  ...
  const order = useSelector(state => state.ostan.table.order);
  const orderBy = useSelector(state => state.ostan.table.orderBy);
  const list = useSelector(state => state.ostan.table.list);
  const page = useSelector(state => state.ostan.table.pageItem.page);
  const total = useSelector(state => state.ostan.table.pageItem.total);
  const rowsPerPage = useSelector(state => state.ostan.table.pageItem.rowsPerPage);
