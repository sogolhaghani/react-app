...
import * as type from './scenariomodel.actions';
import messages from './scenarioModel.messages';

//TODO: remove
const headCells = [
  { id: 'id', align: 'left', disablePadding: true, label: messages.id, sortable: true },
  { id: 'name', align: 'left', disablePadding: false, label: messages.name, sortable: true },
  { id: 'code', align: 'left', disablePadding: false, label: messages.code, sortable: true },
  { id: 'setting', align: 'right', disablePadding: false, label: '', sortable: false },
];
