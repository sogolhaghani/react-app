...
import { handleRequestSort, setPage, loadEntity, createEntity, deleteEntities, handleReadValidation } from './shahr.actions'
...
function EnhancedTableHead(props) {
  ...
  const headCells = useSelector(state => state.shahr.headCells) || []
...
export default function EnhancedTable() {
  ...
  const order = useSelector(state => state.shahr.table.order);
  const orderBy = useSelector(state => state.shahr.table.orderBy);
  const list = useSelector(state => state.shahr.table.list);
  const page = useSelector(state => state.shahr.table.pageItem.page);
  const total = useSelector(state => state.shahr.table.pageItem.total);
  const rowsPerPage = useSelector(state => state.shahr.table.pageItem.rowsPerPage);
