...
import { handleRequestSort, setPage, loadEntity, createEntity, deleteEntities, handleReadValidation } from './product.actions'
...
function EnhancedTableHead(props) {
  ...
  const headCells = useSelector(state => state.product.headCells) || []
...
export default function EnhancedTable() {
  ...
  const order = useSelector(state => state.product.table.order);
  const orderBy = useSelector(state => state.product.table.orderBy);
  const list = useSelector(state => state.product.table.list);
  const page = useSelector(state => state.product.table.pageItem.page);
  const total = useSelector(state => state.product.table.pageItem.total);
  const rowsPerPage = useSelector(state => state.product.table.pageItem.rowsPerPage);
