...
import { handleRequestSort, setPage, loadEntity, createEntity, deleteEntities, handleReadValidation } from './levelgrade.actions'
...
function EnhancedTableHead(props) {
  ...
  const headCells = useSelector(state => state.levelGrade.headCells) || []
...
export default function EnhancedTable() {
  ...
  const order = useSelector(state => state.levelGrade.table.order);
  const orderBy = useSelector(state => state.levelGrade.table.orderBy);
  const list = useSelector(state => state.levelGrade.table.list);
  const page = useSelector(state => state.levelGrade.table.pageItem.page);
  const total = useSelector(state => state.levelGrade.table.pageItem.total);
  const rowsPerPage = useSelector(state => state.levelGrade.table.pageItem.rowsPerPage);
