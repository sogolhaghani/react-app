...
import { handleRequestSort, setPage, loadEntity, createEntity, loadChildren, close, deleteEntities, handleReadValidation } from './resource.actions'
...
const EnhancedTableTRow = (props) => {
  ...
  const lastUpdate = useSelector(state => state.resource.lastUpdate);
...
export default function EnhancedTable() {
  ...
  const order = useSelector(state => state.resource.table.order);
  const orderBy = useSelector(state => state.resource.table.orderBy);
  const list = useSelector(state => state.resource.table.list);
  const page = useSelector(state => state.resource.table.pageItem.page);
  const total = useSelector(state => state.resource.table.pageItem.total);
  const rowsPerPage = useSelector(state => state.resource.table.pageItem.rowsPerPage);
  const messages = useSelector(state => state.resource.messages) || {};
  const baseMessages = useSelector(state => state.base.messages) || {};
  const history = useHistory();
