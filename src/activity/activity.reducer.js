...
import * as type from './activity.actions';
  ...
  switch (action.type) {
    ...
    case type.CREATE_ENTITY:
      ...
      if (action.parentId) {
        ...
        newState.entity.type = activityTypes[activityTypes.indexOf(action.activityType) + 1]
      } else {
        newState.entity.isRoot = true
        newState.entity.type = activityTypes[0]
      }
      newState.entity.modelId = action.modelId
      newState.validations = [];
      return newState;
