...
import * as type from './organizationLevel.actions';
import messages from './organizationLevel.messages';
...
export default function reducer(state = initState, action) {
  ...
  switch (action.type) {
    ...
    case type.READ_VALIDATION:
      ...
      return newState;
    case type.UPDATE_FILTER_LIST:
      newState.table.filterList = action.filterList
      return newState;
    default:
      return state;
  }
